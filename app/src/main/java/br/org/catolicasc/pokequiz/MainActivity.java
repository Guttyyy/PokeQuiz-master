...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DownloadDeDados downloadDeDados = new DownloadDeDados();  //Chama o metodo downloaddedados
        downloadDeDados.execute("https://raw.githubusercontent.com/Biuni/PokemonGO-Pokedex/master/pokedex.json");  //Site que ira fazer o download do json
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(button0 == null || button1 == null || button2 == null || button3 == null){
                    Toast.makeText(MainActivity.this, "Você Errou", Toast.LENGTH_SHORT).show();
                    criaTela();
                }
                else{
